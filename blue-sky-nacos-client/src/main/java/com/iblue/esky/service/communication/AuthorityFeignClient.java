package com.iblue.esky.service.communication;

import com.iblue.esky.service.communication.hystrix.AuthorityFeignClientFallbackFactory;
 ...
 * */
@FeignClient(
        contextId = "AuthorityFeignClient", value = "blue-sky-auth-center",
...
public interface AuthorityFeignClient {
     ...
     * */
    @RequestMapping(value = "/blue-sky-auth-center/authority/token",
